const CTABanner = () => (
  <section className="px-6 md:px-14 py-8 md:py-12 max-w-7xl mx-auto w-full">
    <div className="bg-slate-950 rounded-3xl md:rounded-[40px] py-12 md:py-16 px-6 md:px-10 text-center text-white border border-slate-900 shadow-2xl relative overflow-hidden">
      ...
      <button className="relative z-10 w-full sm:w-auto bg-cyan-400 text-slate-950 hover:bg-cyan-300 px-8 py-3.5 rounded-xl font-bold transition-all active:scale-98 shadow-lg shadow-cyan-500/10 hover:shadow-cyan-500/25 cursor-pointer">
