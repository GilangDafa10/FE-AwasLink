    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#6b7c96] text-slate-100 rounded-2xl p-6 shadow-xs flex flex-col justify-center space-y-2 relative overflow-hidden">
          <h3 className="text-base font-bold text-white z-10">
            Gaya Bahasa Penipu
          </h3>
          <p className="text-xs text-slate-200/90 leading-relaxed max-w-sm z-10">
            Hati-hati dengan "Too Good To Be True" atau "Too Scary To Be
            Ignored". Jika pesan memicu emosi kuat (panik atau senang berlebih),
            itu adalah tanda bahaya pertama rekayasa sosial.
          </p>
      ...
      <div className="bg-[#dbeafe] rounded-2xl p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="space-y-1 text-center sm:text-left">
          <h3 className="text-base font-bold text-slate-800">
            Terima Pesan Mencurigakan?
          </h3>
          <p className="text-xs text-slate-600 leading-relaxed">
            Jangan biarkan mereka memanipulasi Anda. Gunakan alat kami untuk
            mendeteksi apakah sebuah pesan atau link mengandung unsur penipuan
            rekayasa sosial.
          </p>
        </div>
        <button
          onClick={handleClick}
          className="whitespace-nowrap w-full sm:w-auto text-center px-5 py-2.5 bg-[#006677] hover:bg-[#004d5a] text-white text-xs font-bold rounded-xl shadow-md cursor-pointer transition-colors"
        >
          Cek Pesan Sekarang
        </button>
      </div>
